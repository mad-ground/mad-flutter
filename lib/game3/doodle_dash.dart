...
class DoodleDash extends FlameGame
  ...
  void initializeGameStart() {
    ...
    objectManager = ObjectManager(
        minHorizontalDistanceToNextPlatform: levelManager.minDistance,
        maxHorizontalDistanceToNextPlatform: levelManager.maxDistance);
  ...
  void resetGame() {
    startGame();
    ObjectManager.platformSpeed = 200.0;
